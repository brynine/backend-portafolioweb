...
a persistence unit "gproyectoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gproyecto/pom.xml":
...
artifact ("gproyecto.war") is already built. You can build
